...
using static BookStore.Solutions.BasketBuilder;
...
namespace BookStore.Solutions
{
    public class BasketTests
    {
        ...
        [Fact]
        public void give_10_percent_discount_for_IT_books_when_containing_one_of_them()
        {
            var basket = aBasket()
                .With(
                    ITBook().Costing(10.0m))
        ...
        [Fact]
        public void give_20_discount_for_each_Fantasy_book()
        {
            var basket = aBasket()
                .With(
                    FantasyBook().Costing(20.0m),
                    FantasyBook().Costing(10.0m))
                .Build();

            Assert.Equal(24m, basket.PriceWithDiscount());
        }
        ...
        public void combine_10_percent_discount_for_1_IT_book_and_40_percent_discount_for_4_Travel_books()
        {
            ...
            Assert.Equal(59m, basket.PriceWithDiscount());
        }
    }
}
